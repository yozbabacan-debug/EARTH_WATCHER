...
function updatePoliticalSlider() {
  ...
  if (title) title.textContent = "🏛️ Siyasi Olaylar";
...
function extractCountryCoords(text) {
  ...
  const entries = [
    ...
    [53.0, -8.0],
    ["hungary", "macaristan", "hungarian"],
    [47.0, 19.0],
    ["czech", "çekya", "czech republic"],
    [50.0, 15.0],
    ["slovakia", "slovakya", "slovak"],
    [49.0, 19.5],
    ["bulgaria", "bulgaristan", "bulgarian"],
    [43.0, 25.0],
    ["serbia", "sırbistan", "serbian"],
    [44.0, 21.0],
